...
export interface EmissionCalculation {
  ...
  totalScope1Co2: number | null;
  totalScope1Ch4: number | null;
  totalScope1N2o: number | null;
  totalScope1Co2e: number | null;
  totalScope2Co2: number | null;
  totalScope2Ch4: number | null;
  totalScope2N2o: number | null;
  totalScope2Co2e: number | null;
  totalScope3Co2: number | null;
  totalScope3Ch4: number | null;
  totalScope3N2o: number | null;
